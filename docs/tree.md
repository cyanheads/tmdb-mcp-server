...
Generated on: 2026-06-14 01:54:11
...
│   │   │   └── definitions/
│   │   │       ├── index.ts
│   │   │       ├── tmdb-movie.resource.ts
│   │   │       ├── tmdb-person.resource.ts
│   │   │       └── tmdb-tv.resource.ts
│   │   └── tools/
│   │       └── definitions/
│   │           ├── _shared.ts
│   │           ├── index.ts
│   │           ├── tmdb-discover-titles.tool.ts
│   │           ├── tmdb-get-movie.tool.ts
│   │           ├── tmdb-get-person.tool.ts
│   │           ├── tmdb-get-season.tool.ts
│   │           ├── tmdb-get-show.tool.ts
│   │           ├── tmdb-get-trending.tool.ts
│   │           ├── tmdb-get-watch-providers.tool.ts
│   │           └── tmdb-search-titles.tool.ts
│   ├── services/
│   │   └── tmdb/
│   │       ├── tmdb-service.ts
│   │       └── types.ts
